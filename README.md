Link to the dashboard: https://public.tableau.com/views/Lab1tableau/MarketingCustomerValueAnalysis?:language=pt-BR&publish=yes&:sid=&:display_count=n&:origin=viz_share_link
